                                    ...
                                    for ($i = 1; $i <= 10; $i++) {
                                        ...
                                        for ($x = 1; $x <= 5; $x++) {
                                            if($x == 3){
                                                ...
                                                if(empty($book["id"])){
                                                    echo '<td><button data-seat="'.$seat_row_num.'" class="btn-seat btn btn-sm btn-outline-dark" style="background-image: url(\'assets/img/seat.png\'); width: 50px; height: 25px;">
                                                            <span class="seat-number">'.$seat_row_num.'</span></button></td>';
                                                }else{
                                                    echo '<td><button class="btn btn-sm btn-primary" disabled style="background-image: url(\'assets/img/seat.png\'); width: 50px; height: 25px;">
                                                            <span class="seat-number">'.$seat_row_num.'</span></button></td>';
                                                }
                                            }
                                        }
