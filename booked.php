                                    ...
                                    for ($i = 1; $i <= 10; $i++) {
                                        ...
                                        for ($x = 1; $x <= 5; $x++) {
                                            if($x == 3){
                                                ...
                                                if(empty($book["id"])){
                                                    echo '<td><button data-seat="'.$seat_row_num.'" class="btn-seat btn btn-sm btn-block btn-outline-dark" style="background-image: url(\'assets/img/seats.png\'); background-size: cover;">'.$seat_row_num.'</button></td>';
                                                }else{
