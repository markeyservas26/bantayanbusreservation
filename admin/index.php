...
<body class="bg-light"  >
    ...
    <div class="navigation bg-dark">
            <ul class="nav flex-column" style="background:linear-gradient(to right, #0066ff, #003d99);">
        ...
        <div class="main">
            <nav class="navbar navbar-light bg-white justify-content-between">
                <a class="navbar-brand toggle" href="#" onclick="toggleMenu()">
                    ...
                    <span style="font-family: 'Times New Roman', "><b> BANTAYAN ONLINE BUS RESERVATION</b></span>
                </a>
                <div>
